...
public class BlogDto implements Serializable{
	...
	public String toString() {
		return "BlogDto [id=" + id + ", title=" + title + ", imageUrl=" + imageUrl + ", webUrl=" + webUrl + ", originalUrl=" + originalUrl + ", source="
				+ source + ", author=" + author + ", date=" + date + ", global=" + global + ", contentStatus=" + contentStatus + ", rejectionReason="
				+ rejectionReason + ", publishDate=" + publishDate + ", dateCreated=" + dateCreated + "]";
	}
