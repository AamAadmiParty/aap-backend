...
@URLMappings(mappings={
		@URLMapping(id = "userProfileBean3", beanName="userProfileBean2", pattern = "/orig/profile", viewId = "/WEB-INF/jsf/userprofile.xhtml"),
		@URLMapping(id = "userProfileBean4", beanName="userProfileBean2", pattern = "/profile", viewId = "/WEB-INF/jsf/aapstyle/userprofile.xhtml")
		})
@URLBeanName("userProfileBean3")
public class CopyOfUserProfileBean extends BaseJsfBean {
