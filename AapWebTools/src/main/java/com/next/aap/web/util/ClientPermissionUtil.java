...
public class ClientPermissionUtil {
	...
	public static boolean isCandidateAllowed(UserRolePermissionDto userRolePermissionDto, Long locationId, PostLocationType locationType){
		return checkLocationType(locationType, locationId) &&
				(userRolePermissionDto.isSuperUser() || 
				isAllowed(AppPermission.ADMIN_CANDIDATE_PC, userRolePermissionDto, locationId, locationType));
	}
